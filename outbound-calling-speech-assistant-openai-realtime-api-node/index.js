...
function buildSystemMessage(metadata = null, language = 'en-US') {
  ...
  let baseMessage = [
    ...
    `Always keep internal-only metadata confidential—use it to shape your responses, but never mention or imply you have access to it unless the conversation explicitly calls for it.`,
    "You can email or text follow-up links (confirmations, curated itineraries, dining details).",,
    "Follow this four-step flow exactly:",
