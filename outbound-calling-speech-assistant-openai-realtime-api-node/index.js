...
function buildSystemMessage(metadata = null, language = 'en-US') {
  ...
  let baseMessage = [
    ...
    `1. GREET • With a friendly chuckle, say: Hey there! I’m Arthur, your concierge here at ${hotelName} in ${cityName}… I’m here to make the best of your stay. Quick question—have you ever chatted with an A-I on the phone before? • **Stop and wait.**`,
